...
public class CourseServiceImpl implements ICourseService {
	...
	public Course addCourse(Course cObj) throws CourseInvalidException {
		// try {
		// Course exisitingCourse =
		// courseRepository.findByCourseId((String)cObj.getCourseId());
	...
	public Course calculateAverageFeedbackAndUpdate(String courseId, float rating) throws CourseInvalidException {
		...
		// log.info("The method calculateAverageFeedbackAndUpdate has completed
		// successfully");
		// return updateCourse;
		// } catch (Exception e) {
		// // TODO: handle exception
	...
	public float findFeedbackRatingForCourseId(String courseId) throws CourseInvalidException {
		...
		// log.info("The method findFeedbackRatingForCourseId has completed
		// successfully");
		// return rating;
		// } catch (Exception e) {
	...
	public Course deactivateCourse(String courseId) throws CourseInvalidException {
		...
		if (course == null) {
			throw new CourseInvalidException("course does not exist");
		}
		courseRepository.deleteById(courseId);
		// admissionProxy.deactivateCourse(courseId);
		return course;
